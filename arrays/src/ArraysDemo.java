...
Array Definition:
----------------
To represent a group fixed size of similar data elements
 */
public class ArraysDemo {
	public static void main(String[] args) {
		...
		/*
		 1. Store the following employee names Wills, Smith, Jones, Alex, Anna
		...
		int[] subectMarks = {55,44,99,77,88,66};
		//Total Subject Marks
